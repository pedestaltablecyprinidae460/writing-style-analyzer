...
class TestRegressionAgainstBaselines:
    ...
    def test_short_text_matches_baseline(self, sample_text_short, baselines_dir, test_config):
    ...
    def test_long_text_matches_baseline(self, sample_text_long, baselines_dir, test_config):
    ...
    def test_transition_categories_match_baseline(self, sample_text_short, baselines_dir):
...
class TestConsistencyAcrossTexts:
    ...
    def test_longer_text_has_more_words(self, sample_text_short, sample_text_long):
        ...
        assert (
            long_analysis["word_count"] > short_analysis["word_count"]
        ), "Long text should always have more words than short text"

    def test_longer_text_has_more_transitions(self, sample_text_short, sample_text_long):
        ...
        assert (
            long_analysis["total_transitions"] > short_analysis["total_transitions"]
...
class TestProfileBasedRegression:
    ...
    def test_profile_comparison_is_consistent(self, sample_text_short, sample_profile_default):
    ...
    def test_different_targets_scale_expectations(self, sample_text_short, sample_profile_default):
